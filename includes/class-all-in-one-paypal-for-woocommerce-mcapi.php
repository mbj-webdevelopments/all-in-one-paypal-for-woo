...
/**
 * @class       All_In_One_Paypal_For_Woocommerce_Html_output_MailChimp_MCAPI
 * @version	1.0.0
 * @package	paypal-donation-for-wordpress
 * @category	Class
 * @author      johnny manziel <phpwebcreators@gmail.com>
 */
class All_In_One_Paypal_For_Woocommerce_MailChimp_MCAPI {
     ...
     */
    function All_In_One_Paypal_For_Woocommerce_MailChimp_MCAPI($apikey, $secure = false) {
        $this->secure = $secure;
