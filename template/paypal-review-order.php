...
<form class="paypal_express_checkout" method="POST" action="<?php echo add_query_arg( 'pp_action', 'payaction', add_query_arg( 'wc-api', 'All_In_One_Paypal_For_Woocommerce_Admin_WooCommerce_PayPal_Express', home_url( '/' ) ) );?>">
...
$cancel_url = apply_filters( 'paypal_express_review_order_cance_url', $cancel_url );
echo '<div class="clear"></div>';
echo '<p><a class="button paypal_express_cancel" href="' . $cancel_url . '">'.__('Cancel order', 'paypal-for-woocommerce').'</a> ';
